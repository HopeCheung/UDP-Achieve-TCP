    ...
    while True:
        try:
            ...
            if message == None:
                ...
                # case when the packet is correppted
                if csum != rsum:
...
def usage():
    print("Usage: python Receiver3.py Inputfile ReceiverAddress ReceiverPort Outputfile")
    exit()
...
def main():
    ...
    local_socket.bind(("129.236.236.54", 8888))
